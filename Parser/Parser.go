...
func LoadTorrentFileData(torrentPath string) (*TorrentFile, error) {
	...
	if torrentData["announce-list"] != nil {
...
func GetTrackerUrl(torrent TorrentFile) (string, error) {
...
func main() {
	t, err := LoadTorrentFileData("D:\\Coding\\GoProjects\\TorrentFile\\Parser\\torrent.torrent")
	if err != nil {
		fmt.Println(err)
	}
